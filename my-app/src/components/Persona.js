        ...
        <Grid container spacing={3}>
          <Grid item xs={2}>
            <img
              ...
              src="https://images.unsplash.com/photo-1581065178047-8ee15951ede6?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60"
            ></img>
          </Grid>
          <Grid item xs={10}>
            <Typography variant="h4" color="textSecondary" component="h4">
              This is Emily, she loves to study, read books and go out with her
      ...
      <Paper className={classes.paper}>
        <Grid container spacing={3}>
          <Grid item xs={2}>
            <img
              className={classes.image}
              src="https://images.unsplash.com/photo-1596496555044-14173b55edee?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60"
            ></img>
          </Grid>
          <Grid item xs={10}>
            <Typography variant="h4" color="textSecondary" component="h4">
